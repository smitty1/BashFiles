...
if [ -x /usr/bin/dircolors ]; then
    ...
    alias dir='dir -lhF --color=always'
...
alias ll='ls -l'
alias la='ls -A'
alias l='ls -CFlah --group-directories-first'
...
#Reference https://www.2daygeek.com/linux-color-man-pages-configuration-less-most-command/
...
#Make the rm, cp, and mv a little safer.
alias rm='rm -iv'
alias mv='mv -iv'
alias cp='cp -iv'
shopt -s cdspell
